...
unitTest([str ' OuterProduct, [1],[2]'],tprod(X(:,1),1,Y(:,1),2,'m'),tprodm(X(:,1),1,Y(:,1),2,'m'));
unitTest([str ' Inner product, [-1],[-1]'],tprod(X(:,1),-1,Y(:,1),-1,'m'),tprodm(X(:,1),-1,Y(:,1),-1,'m'));
unitTest([str ' Matrix product, [1 -1],[-1 2]'],tprod(X(:,:,1),[1 -1],Y,[-1 2],'m'),tprodm(X(:,:,1),[1 -1],Y,[-1 2],'m'));
unitTest([str ' transposed matrix product, [-1 1],[-1 2]'],tprod(X(:,:,1),[-1 1],Y,[-1 2],'m'),tprodm(X(:,:,1),[-1 1],Y,[-1 2],'m'));
unitTest([str ' Matrix frobenius norm, [-1 -2],[-1 -2]'],tprod(X(:,:,1),[-1 -2],Y,[-1 -2],'m'),tprodm(X(:,:,1),[-1 -2],Y,[-1 -2],'m'));

unitTest([str ' transposed matrix frobenius norm, [-1 -2],[-2 -1]'],tprod(X(:,:,1),[-1 -2],Y,[-2 -1],'m'),tprodm(X(:,:,1),[-1 -2],Y,[-2 -1],'m'));

unitTest([str ' ignored dims, [0 -2],[-2 2 1]'],tprod(Y(1,:),[0 -2],X(:,:,:),[-2 2 1],'m'),tprodm(Y(1,:),[0 -2],X(:,:,:),[-2 2 1],'m'));


% Higher order matrix operations
unitTest([str ' spatio-temporal filter [-1 -2 1],[-1 -2]'],tprod(X,[-1 -2 1],Y,[-1 -2],'m'),tprodm(X,[-1 -2 1],Y,[-1 -2],'m'));

unitTest([str ' spatio-temporal filter (fallback) [-1 -2 1],[-1 -2]'],tprod(X,[-1 -2 1],Y,[-1 -2]),tprodm(X,[-1 -2 1],Y,[-1 -2]));

unitTest([str ' spatio-temporal filter (order) [-1 -2],[-1 -2 1]'],tprod(Y,[-1 -2],X,[-1 -2 1]),tprodm(Y,[-1 -2],X,[-1 -2 1]));

unitTest([str ' spatio-temporal filter (order) [-1 -2],[-1 -2 3]'],tprod(Y,[-1 -2],X,[-1 -2 3]),tprodm(Y,[-1 -2],X,[-1 -2 3]));

unitTest([str ' transposed spatio-temporal filter [1 -2 -3],[-2 -3]'],tprod(X,[1 -2 -3],Y,[-2 -3],'m'),tprodm(X,[1 -2 -3],Y,[-2 -3],'m'));
...
unitTest([str ' matrix-vector product [-1 1 2][-1]'],tprod(X,[-1 1 2],Y(:,1),[-1]),tprodm(X,[-1 1 2],Y(:,1),[-1]));

unitTest([str ' spatial filter (fallback): [-1 2 3],[-1 1]'],tprod(X,[-1 2 3],Y,[-1 1]),tprodm(X,[-1 2 3],Y,[-1 1]));

unitTest([str ' spatial filter: [-1 2 3],[-1 1]'],tprod(X,[-1 2 3],Y,[-1 1],'m'),tprodm(X,[-1 2 3],Y,[-1 1],'m'));

unitTest([str ' spatial filter: [-1 2 3],[-1 1]'],tprod(X,[-1 2 3],Y,[-1 1],'m'),tprodm(X,[-1 2 3],Y,[-1 1],'m'));

%unitTest([str ' temporal filter [1 -2 3],[2 -2]'],tprod(X,[1 -2 3],Y(1,:)),tprodm(X,[-1 2 3],Y,[-1 1],'m'));

unitTest([str ' temporal filter [1 -2 3],[2 -2]'],tprod(X,[1 -2 3],Y(1,:),[2 -2]),tprodm(X,[1 -2 3],Y(1,:),[2 -2]));

%unitTest([str ' temporal filter [2 -2],[1 -2 3]'],tprod(Y(1,:)),tprodm(Y(1,:));

unitTest([str ' temporal filter [-2 2],[1 -2 3]'],tprod(Y(1,:).',[-2 2],X,[1 -2 3],'m'),tprodm(Y(1,:).',[-2 2],X,[1 -2 3],'m'));

unitTest([str ' temporal filter [-2 2],[1 -2 3]'],tprod(Y(1,:).',[-2 2],X,[1 -2 3],'m'),tprodm(Y(1,:).',[-2 2],X,[1 -2 3],'m'));

Xp=permute(X,[1 3 2]);
unitTest([str ' blk-code [-1 1 -2][-1 2 -2]'],tprod(X,[-1 1 -2],X,[-1 2 -2],'m'),tprodm(X,[-1 1 -2],X,[-1 2 -2],'m'));
