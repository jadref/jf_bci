% openbdf() - Opens an BDF File (Biosemi vesrion of European Data Format for Biosignals) in MATLAB (R)
% 
% Usage:
%   >> [EDF,MX,H1]=openbdf(FILENAME)
%
...
function [EDF,MX,H1]=jf_openbdf(FILENAME)
