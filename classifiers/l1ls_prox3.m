function [wb,f,C] = l1ls_prox(X,Y,C,varargin)
...
opts=struct('stepSize',[],'maxIter',5000,'verb',0,'wb',[],'alphab',[],...
            'objTol',0,'tol',0,'tol0',1e-4,'objTol0',1e-3,...
            'lineSearchAccel',1,'lineSearchStep',[1 1.05 4 .1 1.4],'lineSearchIter',6,'structMx',[],'dim',[],...
            'lipzApprox','maxeig','stepLim',[.1 5],'stepLearnRate',[.5 1.1],'minIter',10);
...
for iter=1:opts.maxIter;
  ...
  if ( ~isempty(structMx) )
    ...
    onrm=nrm;
    nrm = max(0,nrm-C*step*giH); % shrink, new group norm
    wb(1:end-1) = double(wb(1:end-1)).*(structMx*(nrm./onrm));% apply shrinkage
    dRw = (structMx*(1./(nrm+double(nrm==0)))).*wb(1:end-1); % for convergence testing
  else
    nrm =abs(wb(1:end-1));
    nrm =max(0,nrm-C*step*iH(1:max(1,end-1))); % shrink
  ...
  % convergence testing
  if ( nsteps<2 ) dw20=max(dw20,dw2); end;
...
% normal
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',0,'stepLim',[1 1], 'lineSearchAccel',0);
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',0,'stepLim',[1 1], 'lineSearchAccel',1);
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',0,'stepLim',[.1 5],'lineSearchAccel',0);
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',0,'stepLim',[.1 5],'lineSearchAccel',1);
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',0,'stepLim',[.1 10],'lineSearchAccel',0,'lipzApprox','hess');
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',0,'stepLim',[.1 10],'lineSearchAccel',1,'lipzApprox','hess');

% with ill-conditioning
Xbad = repop(X,'*',[10;ones(size(X,1)-1,1)]);
[wb,f,J]=l1ls_prox3(Xbad,Y,1,'verb',0,'stepLim',[1 1], 'lineSearchAccel',0,'maxIter',500);
[wb,f,J]=l1ls_prox3(Xbad,Y,1,'verb',0,'stepLim',[1 1], 'lineSearchAccel',1,'maxIter',500);
[wb,f,J]=l1ls_prox3(Xbad,Y,1,'verb',0,'stepLim',[.1 5],'lineSearchAccel',0,'maxIter',500);
[wb,f,J]=l1ls_prox3(Xbad,Y,1,'verb',0,'stepLim',[.1 5],'lineSearchAccel',1,'maxIter',500);
[wb,f,J]=l1ls_prox3(Xbad,Y,1,'verb',0,'stepLim',[.1 5],'lineSearchAccel',0,'lipzApprox','hess','maxIter',500);
[wb,f,J]=l1ls_prox3(Xbad,Y,1,'verb',0,'stepLim',[.1 5],'lineSearchAccel',1,'lipzApprox','hess','maxIter',500);

% with automatic C determination
wb = l1ls_prox(X,Y,1);
...
[wb,f,J]=l1ls_prox(X,Y,1,'verb',1,'structMx',structMx);
[wb,f,J]=l1ls_prox2(X,Y,1,'verb',1,'structMx',structMx);
[wb,f,J]=l1ls_prox3(X,Y,1,'verb',1,'structMx',structMx,'stepLim',[.1 4],'lipzApprox','hess');
